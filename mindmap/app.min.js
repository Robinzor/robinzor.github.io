...
function render(){
  ...
  state.nodes.forEach(n=>{
    ...
    group.addEventListener('pointerdown', (ev)=>{
      ...
      // On touch, mark controls persistent so they stay visible after a tap
      if(ev.pointerType === 'touch'){
        try{
          persistentControls.add(n.id);
          controls.setAttribute('visibility','visible');
          controls.classList.add('persistent');
          controls.classList.remove('faded');
          // Do not schedule an immediate hide here — keep controls until user clears selection
        }catch(e){}
      }
